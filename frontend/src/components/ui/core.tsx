...
export const Modal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-[var(--modal-bg)] border border-[var(--modal-border)] rounded-2xl shadow-2xl animate-in zoom-in-95 duration-200">
        <div className="sticky top-0 z-10 flex items-center justify-between p-6 border-b border-[var(--modal-border)] bg-[var(--modal-header-bg)] backdrop-blur-md">
          <h3 className="text-xl font-bold">{title}</h3>
          <button onClick={onClose} className="p-2 hover:bg-[var(--hover-subtle)] rounded-lg transition-colors">
